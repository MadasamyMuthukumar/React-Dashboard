...
export const Tabledata = [
    { key: 1, name: 'Wireless Earbuds', category: 'Electronics', price: 59.99, stock: 143, sales: 1200 },
    { key: 2, name: 'Leather Wallet', category: 'Accessories', price: 39.99, stock: 89, sales: 800 },
    { key: 3, name: 'Smart Watch', category: 'Electronics', price: 199.99, stock: 56, sales: 650 },
    { key: 4, name: 'Yoga Mat', category: 'Fitness', price: 29.99, stock: 210, sales: 950 },
    { key: 5, name: 'Coffee Maker', category: 'Home', price: 79.99, stock: 78, sales: 720 },
  ];
...
export const ORDER_COLORS = ["#FF6B6B", "#4ECDC4", "#45B7D1", "#FED766", "#2AB7CA"];
